...
class LoginBloc extends THBaseBloc<LoginEvent, LoginState> {
  LoginBloc(this._signInUseCase, this._fetchProfileUseCase) : super(const LoginState()) {
  ...
  void _onUserNameChanged(UserNameChangedEvent event, Emitter<LoginState> emit) async {
  ...
  void _onPasswordChanged(PasswordChangedEvent event, Emitter<LoginState> emit) async {
